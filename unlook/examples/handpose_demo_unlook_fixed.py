...
def run_unlook_hand_tracking_demo(calibration_file=None, output_file=None, visualize_3d=False, timeout=10, verbose=False,
                                  use_led=True, led1_intensity=450, led2_intensity=450):
    """
    ...
    try:
        ...
        # Initialize hand tracker with lower confidence thresholds for better detection
        tracker = HandTracker(
            calibration_file=calibration_file, 
            max_num_hands=4,  # Allow more hands for better detection
            detection_confidence=0.3,  # Lower threshold for initial detection
            tracking_confidence=0.3   # Lower threshold for tracking
        )
...
def main():
    ...
    parser.add_argument('--led1-intensity', type=int, default=450,
                       help='LED1 intensity in mA (0-450, default: 450)')
    parser.add_argument('--led2-intensity', type=int, default=450,
                       help='LED2 intensity in mA (0-450, default: 450)')
